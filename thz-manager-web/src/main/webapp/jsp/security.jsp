...
<body>
  <div style="padding-left: 400px"></div>
    ...
    <form id="form17" action="${pageContext.request.contextPath}/user/modifyMsg_check" method="post" style="padding-top:80px;padding-left:300px;background-color:#F89C88;width:60%;height:80%">
    	<font size="5" style="padding-top:50px;padding-left:140px;">找回密码</font>
    	<br> 手机：&nbsp;&nbsp;<input type="text" value="${phone }" name="phone" id="phone" maxlength="11" onBlur="checkNumber()"></br>
    	<br> 邮箱：&nbsp;&nbsp;<input type="text" value="${email }" name="email" id="email" maxlength="20" onBlur="checkNumber()"></br>
     	<br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;密码：&nbsp;&nbsp;<input type="password" value="${password }" name="password" id="password" maxlength="12" onBlur="vilidate()"><br/>
